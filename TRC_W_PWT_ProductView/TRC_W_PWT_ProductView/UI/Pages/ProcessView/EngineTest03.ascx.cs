...
namespace TRC_W_PWT_ProductView.UI.Pages.ProcessView {
    /// <summary>
    /// (詳細 エンジン 工程) エンジン運転測定(03エンジン)
    /// </summary>
    public partial class EngineTest03 : System.Web.UI.UserControl, Defines.Interface.IDetail {
        ...
        /// 選択行制御
        /// </summary>
        const string LIST_VIEW_SELECTED = "EngineTest03.SelectListViewRow(this,{0},'{1}');";
        const string SUB_LIST_VIEW_SELECTED = "EngineTest03.SelectSubListViewRow(this,{0},'{1}');";
        ...
        public class GRID_MAIN {
            ...
            public static readonly ControlDefine PRODUCT_MODEL_CD = new ControlDefine("txtProductModelCd", "生産型式コード", "productModelCd", ControlDefine.BindType.Down, typeof(String));
            /// <suumary>ベンチNo</summary>
            ...
            /// <suumary>フル電子ガバナ区分</summary>
            public static readonly ControlDefine GONERNOR_TYP = new ControlDefine( "txtGovernorTyp", "フル電子ガバナ区分", "governorTyp", ControlDefine.BindType.Down, typeof( String ) );
            ...
            /// <suumary>第2定格点Qﾗﾝｸ</summary>
            public static readonly ControlDefine TEIKAKU2_RTFLJT_VAL = new ControlDefine( "txtTeikaku2RtfLjtVal", "第2定格点Qﾗﾝｸ", "teikaku2RtfLjtVal", ControlDefine.BindType.Down, typeof( String ) );
            /// <suumary>ラック位置オフセット</summary>
            public static readonly ControlDefine RACK_OFFSET_VAL = new ControlDefine( "txtRackOffsetVal", "ラック位置オフセット", "rackOffsetVal", ControlDefine.BindType.Down, typeof( String ) );
            ...
            /// <suumary>ECU区分</summary>
            public static readonly ControlDefine ECU_TYP = new ControlDefine( "txtEcuTyp", "ECU区分", "ecuTyp", ControlDefine.BindType.Down, typeof( String ) );
            /// <suumary>ﾊｰﾈｽﾘﾚｰ有無</summary>
            public static readonly ControlDefine HARNES_RELAY_FLAG = new ControlDefine( "txtHarnesRelayFlag", "ﾊｰﾈｽﾘﾚｰ有無", "harnesRelayFlag", ControlDefine.BindType.Down, typeof( String ) );
            /// <suumary>燃料区分</summary>
            public static readonly ControlDefine FUEL_TYP = new ControlDefine( "txtFuelTyp", "燃料区分", "fuelTyp", ControlDefine.BindType.Down, typeof( String ) );
            /// <suumary>出力モード</summary>
            public static readonly ControlDefine ENGINE_MODE = new ControlDefine( "txtEngineMode", "出力モード", "engineMode", ControlDefine.BindType.Down, typeof( String ) );
            /// <suumary>TSC SA SELECT</summary>
            public static readonly ControlDefine SA_SELECT = new ControlDefine( "txtSaSelect", "TSC1 SA SELECT", "saSelect", ControlDefine.BindType.Down, typeof( String ) );
            /// <suumary>TSC SA SELECT</summary>
            public static readonly ControlDefine TCO1_SEND = new ControlDefine( "txtTco1Send", "TCO1送信", "tco1Send", ControlDefine.BindType.Down, typeof( String ) );
            /// <suumary>TSC SA SELECT</summary>
            public static readonly ControlDefine TCO1_SA_SELECT = new ControlDefine( "txtTco1SaSelect", "TCO1 SA SELECT", "tco1SaSelect", ControlDefine.BindType.Down, typeof( String ) );
            /// <suumary>CAN通信速度</summary>
            public static readonly ControlDefine CAN_SPEED_TYP = new ControlDefine( "txtCanSpeedTyp", "CAN通信速度", "canSpeedTyp", ControlDefine.BindType.Down, typeof( String ) );
        }
        ...
        public class GRID_SUB {
            ...
            /// <summary>ECU回転数(rpm)</summary>          
            public static readonly ControlDefine ECU_RPM_VAL = new ControlDefine( "ntbEcuRpmVal", "ECU回転数(rpm)", "ecuRpmVal", ControlDefine.BindType.Down, typeof( Decimal ) );
            /// <summary>ｽﾛｯﾄﾙ開度(%)</summary>            
            public static readonly ControlDefine ECU_THROTTLE_VAL = new ControlDefine( "ntbEcuThrottleVal", "ｽﾛｯﾄﾙ開度(%)", "ecuThrottleVal", ControlDefine.BindType.Down, typeof( Decimal ) );
            /// <summary>吸気圧(kPa)</summary>             
            public static readonly ControlDefine ECU_INTAKE_PRS = new ControlDefine( "ntbEcuIntakePrs", "吸気圧(kPa)", "ecuIntakePrs", ControlDefine.BindType.Down, typeof( Decimal ) );
            /// <summary>O2センサPre-cat</summary>         
            public static readonly ControlDefine O2_PRECAT = new ControlDefine( "txtO2Precat", "O2センサPre-cat", "o2Precat", ControlDefine.BindType.Down, typeof( String ) );
            /// <summary>O2センサPost-cat</summary>        
            public static readonly ControlDefine O2_POSTCAT = new ControlDefine( "txtO2Postcat", "O2センサPost-cat", "o2Postcat", ControlDefine.BindType.Down, typeof( String ) );
            /// <summary>補正値(%)</summary>               
            public static readonly ControlDefine BE_VAL = new ControlDefine( "ntbBeVal", "補正値(%)", "beVal", ControlDefine.BindType.Down, typeof( Decimal ) );
            /// <summary>燃費(g/kWh)</summary>             
            public static readonly ControlDefine MILEAGE_VAL = new ControlDefine( "ntbMileageVal", "燃費(g/kWh)", "mileageVal", ControlDefine.BindType.Down, typeof( Decimal ) );
            /// <summary>ECU燃費率(g/s)</summary>          
            public static readonly ControlDefine ECU_MILEAGE_VAL = new ControlDefine( "ntbEcuMileageVal", "ECU燃費率(g/s)", "ecuMileageVal", ControlDefine.BindType.Down, typeof( Decimal ) );
            /// <summary>空気過剰率(%)</summary>           
            public static readonly ControlDefine AF_VAL = new ControlDefine( "ntbAfVal", "空気過剰率(%)", "afVal", ControlDefine.BindType.Down, typeof( Decimal ) );
            /// <summary>ｱｸｾﾙ開度(%)</summary>             
            public static readonly ControlDefine ECU_ACCEL_VAL = new ControlDefine( "ntbEcuAccelVal", "ｱｸｾﾙ開度(%)", "ecuAccelVal", ControlDefine.BindType.Down, typeof( Decimal ) );
            /// <summary>安定時間(sec)</summary>           
            public static readonly ControlDefine STABILITY_TIME = new ControlDefine( "txtStabilityTime", "安定時間(sec)", "stabilityTime", ControlDefine.BindType.Down, typeof( String ) );
            /// <summary>測定時間(sec)</summary>           
            public static readonly ControlDefine MEASURE_AVERAGE = new ControlDefine( "txtMeasureAverage", "測定時間(sec)", "measureAverage", ControlDefine.BindType.Down, typeof( String ) );
        }
        #endregion
