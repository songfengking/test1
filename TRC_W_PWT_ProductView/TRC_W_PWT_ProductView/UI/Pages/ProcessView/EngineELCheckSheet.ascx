<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="EngineELCheckSheet.ascx.cs" Inherits="TRC_W_PWT_ProductView.UI.Pages.ProcessView.EngineELCheckSheet" %>
...
<div class="div-detail-info-margin">
    <div id="divDetailBodyScroll" class="div-fix-scroll" >
        ...
        <%-- 検査情報定義 --%>
        <div id="divMainListArea" runat="server" class="div-y-scroll-flt2" >
                    ...
                    <td>
                        <div id="divLTMainScroll" class="div-fix-scroll div-left-grid">
                            <div id="divMainHeaderLT" runat="server">
                                <asp:GridView id="grvMainHeaderLT" runat="server" CssClass="grid-layout2 ui-widget-content" AllowPaging="false" AllowSorting="false" PageSize="100" AutoGenerateColumns="false">
                    ...
                    <td>
                        <div id="divRTMainScroll" class="div-scroll-right-top div-right-grid">
                            <div id="divMainHeaderRT" runat="server">
                                <asp:GridView ID="grvMainHeaderRT" runat="server" CssClass="grid-layout2 ui-widget-content" AllowPaging="false" AllowSorting="true" PageSize="100" AutoGenerateColumns="false">
                                    <HeaderStyle CssClass="grid-header ui-state-default" />
                                </asp:GridView>
                            </div>
                        </div>
                    ...
                    <td>
                        <div id="divLBMainScroll" class="div-scroll-left-bottom div-left-grid" style="height: 70px">
                            <div id="divGrvLBMain" runat="server">
                                <asp:GridView ID="grvMainViewLB" runat="server" ShowHeader="false" CssClass="grid-layout2 ui-widget-content" AllowPaging="false" AllowSorting="false" PageSize="1000" AutoGenerateColumns="false" OnRowDataBound="grvMainViewLB_RowDataBound" OnSelectedIndexChanged="grvMainViewLB_SelectedIndexChanged">
                                    <HeaderStyle CssClass="grid-header ui-state-default" />
                    ...
                    <td>
                        <div id="divRBMainScroll" class="div-visible-scroll div-right-grid" style="height: 70px">
                            <div id="divGrvRBMain" runat="server">
                                <asp:GridView ID="grvMainViewRB" runat="server" ShowHeader="false" CssClass="grid-layout2 ui-widget-content" AllowPaging="false" AllowSorting="false" PageSize="1000" AutoGenerateColumns="false" OnRowDataBound="grvMainViewRB_RowDataBound" OnSelectedIndexChanged="grvMainViewRB_SelectedIndexChanged">
                                    <HeaderStyle CssClass="grid-header ui-state-default" />
                                    <RowStyle CssClass="grid-row ui-widget" />
                                    <SelectedRowStyle CssClass="grid-row ui-widget ui-state-highlight" />
                                </asp:GridView>
