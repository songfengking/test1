<%@ Page Language="C#" MasterPageFile="~/UI/MasterForm/MasterMain.master" AutoEventWireup="true" CodeBehind="AnlGroupList.aspx.cs" Inherits="TRC_W_PWT_ProductView.UI.Pages.AiImageCheck.AnlGroupList" %>
...
<asp:Content ID="MasterScript" ContentPlaceHolderID="MasterScript" runat="server">
	<script src="<%: PageUtils.ResolveUrl( this.Page, "~/Scripts/Pages/AiImageCheck/AnlGroupList.js") %>"></script>
							...
							<asp:GridView ID="grvMainViewLB" runat="server" ShowHeader="false" CssClass="grid-layout2 ui-widget-content" AllowPaging="true" AllowSorting="false" PageSize="50" AutoGenerateColumns="false" OnRowDataBound="grvMainViewLB_RowDataBound">
								...
								<Columns>
									...
									<asp:TemplateField HeaderText="INDEX_NO">
										<ItemTemplate>
											<KTCC:KTTextBox ID="inputIndexNo" runat="server" CssClass="font-default txt-default ime-inactive txt-width-long" AutoUpper="False" />
										</ItemTemplate>
									</asp:TemplateField>
					...
					<div id="divRBScroll" class="div-visible-scroll div-right-grid">
						<div id="divGrvRB" runat="server">
							<asp:GridView ID="grvMainViewRB" runat="server" ShowHeader="false" CssClass="grid-layout2 ui-widget-content" AllowPaging="true" AllowSorting="false" PageSize="50" AutoGenerateColumns="false" OnRowDataBound="grvMainViewRB_RowDataBound">
								...
								<Columns>
									<%-- 非表示項目 --%>
									<asp:TemplateField HeaderText="INDEX_NO_ENABLE1" />
								</Columns>
							</asp:GridView>
						</div>
					</div>
...
<asp:Content ID="MasterBodyBottom" ContentPlaceHolderID="MasterBodyBottom" runat="server">
	<div id="divGrvCtrlButton" runat="server" class="div-bottom-button-area">
		<KTCC:KTButton ID="btnAllCheck" runat="server" Text="すべて選択" CssClass="btn-middle" Style="margin-right: 20px" OnClientClick="AnlGroupList.AllCheck(); return false;" />
		<KTCC:KTButton ID="btnUp" runat="server" Text="上に移動" CssClass="btn-middle" OnClick="btnUp_Click" Style="margin-right: 20px" />
		<KTCC:KTButton ID="btnDown" runat="server" Text="下に移動" CssClass="btn-middle" OnClick="btnDown_Click" Style="margin-right: 20px" />
		<KTCC:KTButton ID="btnUpdate" runat="server" Text="更新" CssClass="btn-middle" Style="margin-right: 20px" OnClick="btnUpdate_Click" />
		<KTCC:KTButton ID="btnInsert" runat="server" Text="追加" CssClass="btn-middle" Style="margin-right: 20px" />
		<KTCC:KTButton ID="btnDelete" runat="server" Text="削除" CssClass="btn-middle" OnClick="btnDelete_Click" Style="margin-right: 20px" />
	</div>
</asp:Content>
