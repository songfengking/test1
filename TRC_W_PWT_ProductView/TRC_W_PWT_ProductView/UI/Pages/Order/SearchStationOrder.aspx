<%@ Page Language="C#" MasterPageFile="~/UI/MasterForm/MasterMain.master" AutoEventWireup="true" CodeBehind="SearchStationOrder.aspx.cs" Inherits="TRC_W_PWT_ProductView.UI.Pages.Order.SearchStationOrder" %>
...
<asp:Content ID="MasterScript" ContentPlaceHolderID="MasterScript" runat="server">
    <script src="<%: PageUtils.ResolveUrl( this.Page, "~/Scripts/Pages/Order/SearchStationOrder.js") %>"></script>
</asp:Content>
                                        ...
                                        <table class="table-border-layout">
                                            ...
                                            <tr class="tr-condition-body">
                                                <td>
                                                    <table class="table-condition-sub">
                                                        <tr class="font-default">
                                                            <td style="width: 100px">ステーション</td>
                                                            <td>
                                                                <div>
                                                                    <KTCC:KTDropDownList ID="ddlStation" runat="server" CssClass="font-default txt-default ime-inactive ddl-width-long ddl-default" AutoPostBack="True" CausesValidation="True" onchange="$('#MasterBody_btnSearch').click();" />
                                                                </div>
                                                            </td>
                                                        </tr>
                                                    </table>
                                                ...
                                                <td>
                                                    <table class="table-condition-sub">
                                                        <tr class="font-default">
                                                            <td style="width: 60px">照会日</td>
                                                            <td>
                                                                <KTCC:KTCalendar ID="cldJissekiYmd" runat="server" UseCalendar="true" Type="yyyyMMdd" CssClass="font-default txt-default cld-ymd"></KTCC:KTCalendar>
                                                            </td>
                                                        </tr>
                                                    </table>
                                                </td>
                ...
                <td>
                    <div id="divLTScroll" class="div-fix-scroll div-left-grid">
                        <div id="divGrvHeaderLT" runat="server">
                            <asp:GridView ID="grvHeaderLT" runat="server" CssClass="grid-layout2 ui-widget-content" AllowPaging="false" AllowSorting="true" PageSize="1000" AutoGenerateColumns="false" OnSorting="grvSearchStationOrder_Sorting">
                ...
                <td>
                    <div id="divRTScroll" class="div-scroll-right-top div-right-grid">
                        <div id="divGrvHeaderRT" runat="server">
                            <asp:GridView ID="grvHeaderRT" runat="server" CssClass="grid-layout2 ui-widget-content" AllowPaging="false" AllowSorting="true" PageSize="1000" AutoGenerateColumns="false" OnSorting="grvSearchStationOrder_Sorting">
                                <HeaderStyle CssClass="grid-header ui-state-default" />
                            </asp:GridView>
                        </div>
                    </div>
                ...
                <td>
                    <div id="divLBScroll" class="div-scroll-left-bottom div-left-grid">
                        <div id="divGrvLB" runat="server">
                            <asp:GridView ID="grvSearchStationOrderLB" runat="server" ShowHeader="false" CssClass="grid-layout2 ui-widget-content" AllowPaging="true" AllowSorting="false" PageSize="1000" AutoGenerateColumns="false" OnRowDataBound="grvSearchStationOrder_RowDataBound">
                                ...
                                <Columns>
                                    ...
                                    <asp:TemplateField HeaderText="JISSEKI_YM_NUM" />
                                    <asp:TemplateField HeaderText="JISSEKI_DATE" />
                ...
                <td>
                    <div id="divRBScroll" class="div-visible-scroll div-right-grid">
                        <div id="divGrvRB" runat="server">
                            <asp:GridView ID="grvSearchStationOrderRB" runat="server" ShowHeader="false" CssClass="grid-layout2 ui-widget-content" AllowPaging="true" AllowSorting="false" PageSize="1000" AutoGenerateColumns="false" OnRowDataBound="grvSearchStationOrder_RowDataBound">
                                <PagerSettings Position="TopAndBottom" Mode="NumericFirstLast" PageButtonCount="10" Visible="false" />
                                <HeaderStyle CssClass="grid-header ui-state-default" />
                                <RowStyle CssClass="grid-row ui-widget" />
                                <SelectedRowStyle CssClass="ui-state-highlight" />
                                <Columns>
                                    ...
                                    <asp:TemplateField HeaderText="ENGINE_KOUSU_RANK" />
                                </Columns>
                            </asp:GridView>
                        </div>
                    </div>
