<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="SupplyPump.ascx.cs" Inherits="TRC_W_PWT_ProductView.UI.Pages.PartsView.SupplyPump" %>
    ...
    <div>
        ...
        <div id="divMainListArea" class="div-auto-scroll" >
            <asp:ListView ID="lstMainList" runat="server" OnItemDataBound="lstMainList_ItemDataBound">
                <LayoutTemplate>
                    <table id="itemPlaceholderContainer" runat="server" class="grid-layout" style="width: 810px; height:auto">
