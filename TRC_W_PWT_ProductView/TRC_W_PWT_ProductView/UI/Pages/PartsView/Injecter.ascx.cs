...
namespace TRC_W_PWT_ProductView.UI.Pages.PartsView {
    ...
    /// エンジン部品詳細画面:インジェクター
    /// </summary>
    public partial class Injecter : System.Web.UI.UserControl, Defines.Interface.IDetail {
        ...
        public class GRID_SUB {
            /// <summary>TR</summary>
            public static readonly ControlDefine TR_ROW_DATA = new ControlDefine( "trRowData", "TR", "", ControlDefine.BindType.None, typeof( String ) );
            /// <summary>気筒番号</summary>
            public static readonly ControlDefine CYLINDER_NUM = new ControlDefine( "ntbCylinderNum", "気筒番号", "cylinderNum", ControlDefine.BindType.Down, typeof( int ) );
            ...
            /// <summary>噴射量補正データ</summary>
            public static readonly ControlDefine ADJUST_VAL = new ControlDefine( "txtInjectionQuantityAdjustVal", "噴射量補正データ", "injectionQuantityAdjustVal", ControlDefine.BindType.Down, typeof( string ) );
            /// <summary>メーカー</summary>
            public static readonly ControlDefine MAKER_NM = new ControlDefine( "txtMakerNm", "メーカー", "makerNm", ControlDefine.BindType.Down, typeof( string ) );
            /// <summary>製番</summary>
            public static readonly ControlDefine SERIAL = new ControlDefine( "txtInjecterSerial", "製番", "injecterSerial", ControlDefine.BindType.Down, typeof( string ) );
            /// <summary>圧力水準</summary>
            public static readonly ControlDefine PRESSURE_LV = new ControlDefine( "txtPressureLv", "圧力水準", "pressureLv", ControlDefine.BindType.Down, typeof( string ) );
            /// <summary>端末名ホスト名</summary>
        ...
        internal class GRID_MAIN_COMMON {
            ...
            public static readonly GridViewDefine INSTALL_DT = new GridViewDefine( "組付日時", "installDt", typeof( DateTime ), "{0:yyyy/MM/dd HH:mm:ss}", false, HorizontalAlign.Center, 150, true, true );
            /// <summary>ステーション名</summary>
            public static readonly GridViewDefine STATION_NM = new GridViewDefine( "ステーション名", "stationNm", typeof( string ), "", false, HorizontalAlign.Left, 160, true, true );
            /// <summary>部品機番</summary>
        ...
        internal class GRID_SUB_COMMON {
            /// <summary>気筒No</summary>
            public static readonly GridViewDefine CYLINDER_NUM = new GridViewDefine( "気筒No", "cylinderNum", typeof( string ), "", false, HorizontalAlign.Right, 60, true, true );
            ...
            /// <summary>噴射量補正データ</summary>
            public static readonly GridViewDefine ADJUST_VAL = new GridViewDefine( "噴射量<br />補正データ", "injectionQuantityAdjustVal", typeof( string ), "", false, HorizontalAlign.Left, 240, true, true );
            /// <summary>メーカー</summary>
            public static readonly GridViewDefine MAKER_NM = new GridViewDefine( "メーカー", "makerNm", typeof( string ), "", false, HorizontalAlign.Center, 80, true, true );
            /// <summary>製番</summary>
            public static readonly GridViewDefine SERIAL = new GridViewDefine( "インジェクタ<br />製番", "injecterSerial", typeof( string ), "", false, HorizontalAlign.Center, 140, true, true );
            /// <summary>圧力水準</summary>
            public static readonly GridViewDefine PRESSURE_LV = new GridViewDefine( "圧力水準", "pressureLv", typeof( string ), "", false, HorizontalAlign.Center, 80, true, true );
        ...
        /// <param name="sender"></param>
        /// <param name="e"></param>
        protected void grvMainViewLBSub_RowDataBound( object sender, GridViewRowEventArgs e ) {
        ...
        /// <param name="sender"></param>
        /// <param name="e"></param>
        protected void grvMainViewRBSub_RowDataBound( object sender, GridViewRowEventArgs e ) {
        ...
        public void Initialize() {
            ...
            try {
                resultSet = Business.DetailViewBusiness.SelectEngineInjecterDetail( DetailKeyParam.ProductModelCd, DetailKeyParam.Serial );
        ...
        private void InitializeValues( Business.DetailViewBusiness.ResultSet resultSet ) {
            ...
            */
            ...
            lstSubList.DataSource = resultSet.SubTable;
            lstSubList.DataBind();

            lstSubList.SelectedIndex = 0;
            */
            ...
            if ( 0 < resultSet.SubTable.Rows.Count ) {
                ...
                //グリッドビューバインド
                GridView frozenGrid = grvMainViewLBSub;
                if ( 0 < resultSet.SubTable.Rows.Count ) {

                    //新規バインド
                    ControlUtils.ShowGridViewHeader( grvHeaderLTSub, ControlUtils.GetFrozenColumns( frozenGrid, gridColumns, true ), cond_sub, true );
                    ControlUtils.ShowGridViewHeader( grvHeaderRTSub, ControlUtils.GetFrozenColumns( frozenGrid, gridColumns, false ), cond_sub, true );
                    ControlUtils.BindGridView_WithTempField( grvMainViewLBSub, ControlUtils.GetFrozenColumns( frozenGrid, gridColumns, true ), cond_sub.ResultData );
                    ControlUtils.BindGridView_WithTempField( grvMainViewRBSub, ControlUtils.GetFrozenColumns( frozenGrid, gridColumns, false ), cond_sub.ResultData );
        ...
        private void SetDivGridSubViewWidth() {
            SetDivGridViewWidth( grvHeaderLTSub, divGrvHeaderLTSub );
            SetDivGridViewWidth( grvHeaderRTSub, divGrvHeaderRTSub );

            SetDivGridViewWidth( grvMainViewLBSub, divGrvLBSub );
            SetDivGridViewWidth( grvMainViewRBSub, divGrvRBSub );
        }

        /// <summary>
        /// グリッドビュークリア
        /// </summary>
        private void ClearGridSubView() {

            //列名非表示 グリッドビュークリア
            ControlUtils.InitializeGridView( grvHeaderLTSub, false );
            ControlUtils.InitializeGridView( grvHeaderRTSub, false );
            ControlUtils.InitializeGridView( grvMainViewLBSub, false );
            ControlUtils.InitializeGridView( grvMainViewRBSub, false );
