...
namespace TRC_W_PWT_ProductView.UI.Pages.PartsView {
    public partial class Housing : System.Web.UI.UserControl, Defines.Interface.IDetail {
        //ロガー定義
        ...
        public void Initialize() {
            ...
            try {
                tblMain = Business.DetailViewBusiness.SelectTractorHousingDetail ( DetailKeyParam.ProductModelCd, DetailKeyParam.Serial ).MainTable;
