...
namespace TRC_W_PWT_ProductView.UI.Pages.PartsView {
    ...
    /// トラクタ部品詳細画面:ロプス
    /// </summary>
    public partial class Rops : System.Web.UI.UserControl, Defines.Interface.IDetail {
        ...
        public class GRID_MAIN {
            ...
            /// <summary>ロプス型式名</summary>
            public static readonly ControlDefine ROPS_MODEL_NUM = new ControlDefine( "txtRopsModelNum", "ロプス品番", "ropsModelCd", ControlDefine.BindType.Down, typeof( string ) );
            /// <summary>ロプス機番</summary>
            public static readonly ControlDefine ROPS_SERIAL = new ControlDefine( "txtRopsSerial", "ロプス機番", "ropsSerial", ControlDefine.BindType.Down, typeof( string ) );
        }
        ...
        public void Initialize() {
            ...
            try {
                tblMain = Business.DetailViewBusiness.SelectTractorRopsDetail( DetailKeyParam.ProductModelCd, DetailKeyParam.Idno ).MainTable;
