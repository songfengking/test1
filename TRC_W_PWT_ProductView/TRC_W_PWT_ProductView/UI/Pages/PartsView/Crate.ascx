<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="Crate.ascx.cs" Inherits="TRC_W_PWT_ProductView.UI.Pages.PartsView.Crate" %>
    ...
    <div>
        ...
        <div id="divMainListArea" class="div-auto-scroll">
            <table id="tblMain" class="table-border-layout grid-layout" style="width: 900px; height: auto;margin-left:10px" runat="server">
                ...
                <tr class="detailtable-header">
                    <td class="ui-state-default detailtable-header">クレート機番</td>
                    <td>
                        <KTCC:KTTextBox ID="txtCrateSerial" runat="server" ReadOnly="true" CssClass="font-default txt-default txt-width-full" />
                    </td>
                    <td colspan="2"></td>
                </tr>
            </table>
