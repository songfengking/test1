...
namespace TRC_W_PWT_ProductView.UI.Pages.PartsView {
    ...
    /// エンジン部品詳細画面:サプライポンプ
    /// </summary>
    public partial class SupplyPump : System.Web.UI.UserControl, Defines.Interface.IDetail {
        ...
        public void Initialize() {
            ...
            try {
                switch ( DetailKeyParam.ClassCd ) {
                case PartsKind.PARTS_CD_ENGINE_IPU:         //IPU
                    resultSet = Business.DetailViewBusiness.SelectEngineIpuDetail( DetailKeyParam.ProductModelCd, DetailKeyParam.Serial );
                    break;

                case PartsKind.PARTS_CD_ENGINE_EHC:         //EHC
                    resultSet = Business.DetailViewBusiness.SelectEngineEhcDetail( DetailKeyParam.ProductModelCd, DetailKeyParam.Serial );
                    break;

                case PartsKind.PARTS_CD_ENGINE_SUPPLYPUMP:  //サプライポンプ
                default:
                    //サプライポンプ
                    resultSet = Business.DetailViewBusiness.SelectEngineSupplyPumpDetail( DetailKeyParam.ProductModelCd, DetailKeyParam.Serial );
                    break;
                }
