...
namespace TRC_W_PWT_ProductView.UI.Pages.PartsView {
    ...
    /// エンジン部品詳細画面:DPF
    /// </summary>
    public partial class Dpf : System.Web.UI.UserControl, Defines.Interface.IDetail {
        ...
        public class GRID_MAIN {
            ...
            public static readonly ControlDefine PROCESS_YMD = new ControlDefine( "txtProcessYmd", "加工日", "processYmd", ControlDefine.BindType.Down, typeof( DateTime ) );
            /// <summary>連番</summary>
        ...
        public void Initialize() {
            ...
            try {
                tblMain = Business.DetailViewBusiness.SelectEngineDpfDetail( DetailKeyParam.ProductModelCd, DetailKeyParam.Serial ).MainTable;
