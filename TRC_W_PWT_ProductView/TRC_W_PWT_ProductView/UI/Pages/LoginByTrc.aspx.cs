...
namespace TRC_W_PWT_ProductView.UI.Pages {
    ...
    public partial class LoginByTrc : BaseForm {
        ...
        private void RedirectPage() {
			...
			userInfoDto.apAuthList = new string[] { "NACHECKLIST_View", "NACHECKLIST_Edit", "PROCESSINGDTEDIT_View", "AnlGroupInput_View", "AnlGroupInput_Edit", "MainCorrectiveInput_View", "MainCorrectiveInput_Edit", "AnlItemInput_View", "AnlItemInput_Edit", "AnlGroupModelInput_View", "AnlGroupModelInput_Edit" };
