...
namespace TRC_W_PWT_ProductView.UI.Pages.UserControl {
    ...
    public partial class InputModal : System.Web.UI.UserControl {
...
//            MainModal.Attributes["onload"] = "return InputModal.setIframe();";
        ...
        public static string CreateDispUrl( Control setCtrl, PageInfo.ST_PAGE_INFO prmPage, int width, int height, ListItem[] keyItems, string extendKey ) {
            ...
            //key設定
            if ( keyItems != null && 0 != keyItems.Length ) {
            ...
            string retURL = "return InputModal.btnOpen('" + prmPage.pageId + "','" + strUrl + "','" + extendKey + "')";
