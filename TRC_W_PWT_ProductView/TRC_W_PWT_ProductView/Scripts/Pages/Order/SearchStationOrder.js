...
SearchStationOrder = {
    ...
    ResizeGridArea2: function () {
        ...
        if (null != containtsArea.position()) {
            containtsBottom = containtsBottomArea.position().top - containtsArea.position().top + SearchStationOrder.MIN_HEIGHT;
        ...
        if (0 < gridLT.length) {
            ...
            try {
                divMain_Height = containtsBottom - divMain_Top - SearchStationOrder.INNER_DIV_H_MARGIN;
    ...
    ,
    Initialize: function () {
        $("#" + SearchStationOrder.GRID_RB).scroll(function () {
            var gridRT = $("#" + SearchStationOrder.GRID_RT);
            var gridLB = $("#" + SearchStationOrder.GRID_LB);
            var gridRB = $("#" + SearchStationOrder.GRID_RB);
        ...
        $("#" + SearchStationOrder.GRID_LB).scroll(function () {
            var gridLB = $("#" + SearchStationOrder.GRID_LB);
            var gridRB = $("#" + SearchStationOrder.GRID_RB);
        ...
        $("#" + SearchStationOrder.GRID_LB).on(Common.GetWheelEvent(), function (e) {
            var gridLB = $("#" + SearchStationOrder.GRID_LB);
            gridLB.scrollTop(gridLB.scrollTop() - Common.GetWheelDelta(e));
        });
        $("#" + SearchStationOrder.GRID_RB).on(Common.GetWheelEvent(), function (e) {
            var gridRB = $("#" + SearchStationOrder.GRID_RB);
