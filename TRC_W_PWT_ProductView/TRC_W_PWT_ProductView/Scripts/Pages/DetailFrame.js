//////////////////////////////////////////////////////////////////////////////////////////////
//詳細画面 外枠(DetailFrame)用コントロール制御関数
///////////////////////////////////////////////////////////////////////////////////////////////
//メイン処理からの各画面派生呼び出し(PageLoad)
function MasterMainPageLoaded() {
    DetailFrame.PreLoadCSSImage();
    if (typeof DetailFramePageLoaded == "function") {
        DetailFramePageLoaded();
    }
}
//メイン処理からの各画面派生呼び出し(Resize)
function MasterMainPageResized() {
    DetailFrame.ResizeDivArea();
    if (typeof DetailFramePageResized == "function") {
        DetailFramePageResized();
    }
}
