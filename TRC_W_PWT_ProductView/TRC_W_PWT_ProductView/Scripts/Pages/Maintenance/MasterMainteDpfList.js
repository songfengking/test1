///////////////////////////////////////////////////////////////////////////////////////////////
//  DPF機番情報修正画面(MasterMainteDpfList)用制御関数
///////////////////////////////////////////////////////////////////////////////////////////////
//メイン処理からの各画面派生呼び出し(PageLoad)
function MasterMainPageLoaded() {
    MasterMainteDpfList.Initialize();
    MasterMainteDpfList.ResizeGridArea();
}
...
MasterMainteDpfList = {
    ...
    ResizeGridArea: function () {
        ...
        if (null != containtsArea.position()) {
            containtsBottom = containtsBottomArea.position().top - containtsArea.position().top + MasterMainteDpfList.MIN_HEIGHT;
        ...
        if (0 < gridLT.length) {
            ...
            try {
                divMain_Height = containtsBottom - divMain_Top - MasterMainteDpfList.INNER_DIV_H_MARGIN;
    ...
    ,
    Initialize: function () {
        $("#" + MasterMainteDpfList.GRID_RB).scroll(function () {
            var gridRT = $("#" + MasterMainteDpfList.GRID_RT);
            var gridLB = $("#" + MasterMainteDpfList.GRID_LB);
            var gridRB = $("#" + MasterMainteDpfList.GRID_RB);
        ...
        $("#" + MasterMainteDpfList.GRID_LB).scroll(function () {
            var gridLB = $("#" + MasterMainteDpfList.GRID_LB);
            var gridRB = $("#" + MasterMainteDpfList.GRID_RB);
        ...
        $("#" + MasterMainteDpfList.GRID_LB).on(Common.GetWheelEvent(), function (e) {
            var gridLB = $("#" + MasterMainteDpfList.GRID_LB);
            gridLB.scrollTop(gridLB.scrollTop() - Common.GetWheelDelta(e));
        });
        $("#" + MasterMainteDpfList.GRID_RB).on(Common.GetWheelEvent(), function (e) {
            var gridRB = $("#" + MasterMainteDpfList.GRID_RB);
