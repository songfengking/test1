...
EngineTest07 = {
    ...
    ResizeDivArea: function () {
        ...
        var gridSubLT = $("#" + EngineTest07.SUB_GRID_LT);
        var gridSubRT = $("#" + EngineTest07.SUB_GRID_RT);
        var gridSubLB = $("#" + EngineTest07.SUB_GRID_LB);
        var gridSubRB = $("#" + EngineTest07.SUB_GRID_RB);
    ...
    Initialize: function () {
        ...
        //メイン
        $("#" + EngineTest07.GRID_RB).scroll(function () {
            var gridRT = $("#" + EngineTest07.GRID_RT);
            var gridLB = $("#" + EngineTest07.GRID_LB);
            var gridRB = $("#" + EngineTest07.GRID_RB);
        ...
        $("#" + EngineTest07.GRID_LB).scroll(function () {
            var gridLB = $("#" + EngineTest07.GRID_LB);
            var gridRB = $("#" + EngineTest07.GRID_RB);
        ...
        $("#" + EngineTest07.GRID_LB).on(Common.GetWheelEvent(), function (e) {
            var gridLB = $("#" + EngineTest07.GRID_LB);
            gridLB.scrollTop(gridLB.scrollTop() - Common.GetWheelDelta(e));
        });
        $("#" + EngineTest07.GRID_RB).on(Common.GetWheelEvent(), function (e) {
            var gridRB = $("#" + EngineTest07.GRID_RB);
        ...
        //サブ
        $("#" + EngineTest07.SUB_GRID_RB).scroll(function () {
            var gridRT = $("#" + EngineTest07.SUB_GRID_RT);
            var gridLB = $("#" + EngineTest07.SUB_GRID_LB);
            var gridRB = $("#" + EngineTest07.SUB_GRID_RB);
            if (gridRB.scrollTop() != gridLB.scrollTop()) {
                gridLB.scrollTop(gridRB.scrollTop());
            }
            if (gridRB.scrollLeft() != gridRT.scrollLeft()) {
        ...
        $("#" + EngineTest07.SUB_GRID_LB).scroll(function () {
            var gridLB = $("#" + EngineTest07.SUB_GRID_LB);
            var gridRB = $("#" + EngineTest07.SUB_GRID_RB);
            if (gridLB.scrollTop() != gridRB.scrollTop()) {
                gridRB.scrollTop(gridLB.scrollTop());
        ...
        $("#" + EngineTest07.SUB_GRID_LB).on(Common.GetWheelEvent(), function (e) {
            var gridLB = $("#" + EngineTest07.SUB_GRID_LB);
            gridLB.scrollTop(gridLB.scrollTop() - Common.GetWheelDelta(e));
        });
        $("#" + EngineTest07.SUB_GRID_RB).on(Common.GetWheelEvent(), function (e) {
            var gridRB = $("#" + EngineTest07.SUB_GRID_RB);
            gridRB.scrollTop(gridRB.scrollTop() - Common.GetWheelDelta(e));
        });
    }
