///////////////////////////////////////////////////////////////////////////////////////////////
//詳細画面 トラクタ走行検査(TractorAll)用コントロール制御関数
///////////////////////////////////////////////////////////////////////////////////////////////
/* トラクタ走行検査用制御 */
//メイン処理からの各画面派生呼び出し(PageLoad)
function DetailFramePageLoaded() {
    //var viewer = new ScrollViewer("#" + TractorAll.DIV_VIEW_BOX);
    TractorAll.AfterImageLoad();
    TractorAll.Initialize();
}
//メイン処理からの各画面派生呼び出し(Resize)
function DetailFramePageResized() {
    TractorAll.ResizeDivArea();
}
TractorAll = {
    //定数
    ...
    ResizeDivArea: function () {
        ...
        if (0 < gridLTMain.length) {
            ...
            try {
                ...
                divR_Width = tblHeaders_Width - divR_Left + TractorAll.INNER_DIV_MARGIN_3;
            ...
            try {
                //                divMain_Height = containtsBottom - divMain_Top - TractorAll.INNER_DIV_MARGIN_12;
    ...
    Initialize: function () {
        ...
        //メインタブ
        $("#" + TractorAll.GRID_MAIN_RB).scroll(function () {
            var gridRTMain = $("#" + TractorAll.GRID_MAIN_RT);
            var gridLBMain = $("#" + TractorAll.GRID_MAIN_LB);
            var gridRBMain = $("#" + TractorAll.GRID_MAIN_RB);
        ...
        $("#" + TractorAll.GRID_MAIN_LB).scroll(function () {
            var gridLBMain = $("#" + TractorAll.GRID_MAIN_LB);
            var gridRBMain = $("#" + TractorAll.GRID_MAIN_RB);
        ...
        $("#" + TractorAll.GRID_MAIN_LB).on(Common.GetWheelEvent(), function (e) {
            var gridLBMain = $("#" + TractorAll.GRID_MAIN_LB);
            gridLBMain.scrollTop(gridLBMain.scrollTop() - Common.GetWheelDelta(e));
        });
        $("#" + TractorAll.GRID_MAIN_RB).on(Common.GetWheelEvent(), function (e) {
            var gridRBMain = $("#" + TractorAll.GRID_MAIN_RB);
