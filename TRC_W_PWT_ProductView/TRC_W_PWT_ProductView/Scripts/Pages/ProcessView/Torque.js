...
Torque = {
    ...
    ResizeDivArea: function () {
        ...
        var gridSubLT = $("#" + Torque.SUB_GRID_LT);
        var gridSubRT = $("#" + Torque.SUB_GRID_RT);
        var gridSubLB = $("#" + Torque.SUB_GRID_LB);
        var gridSubRB = $("#" + Torque.SUB_GRID_RB);
    ...
    Initialize: function () {
        ...
        //メイン
        $("#" + Torque.GRID_RB).scroll(function () {
            var gridRT = $("#" + Torque.GRID_RT);
            var gridLB = $("#" + Torque.GRID_LB);
            var gridRB = $("#" + Torque.GRID_RB);
        ...
        $("#" + Torque.GRID_LB).scroll(function () {
            var gridLB = $("#" + Torque.GRID_LB);
            var gridRB = $("#" + Torque.GRID_RB);
        ...
        $("#" + Torque.GRID_LB).on(Common.GetWheelEvent(), function (e) {
            var gridLB = $("#" + Torque.GRID_LB);
            gridLB.scrollTop(gridLB.scrollTop() - Common.GetWheelDelta(e));
        });
        $("#" + Torque.GRID_RB).on(Common.GetWheelEvent(), function (e) {
            var gridRB = $("#" + Torque.GRID_RB);
        ...
        //サブ
        $("#" + Torque.SUB_GRID_RB).scroll(function () {
            var gridRT = $("#" + Torque.SUB_GRID_RT);
            var gridLB = $("#" + Torque.SUB_GRID_LB);
            var gridRB = $("#" + Torque.SUB_GRID_RB);
            if (gridRB.scrollTop() != gridLB.scrollTop()) {
                gridLB.scrollTop(gridRB.scrollTop());
            }
            if (gridRB.scrollLeft() != gridRT.scrollLeft()) {
        ...
        $("#" + Torque.SUB_GRID_LB).scroll(function () {
            var gridLB = $("#" + Torque.SUB_GRID_LB);
            var gridRB = $("#" + Torque.SUB_GRID_RB);
            if (gridLB.scrollTop() != gridRB.scrollTop()) {
                gridRB.scrollTop(gridLB.scrollTop());
        ...
        $("#" + Torque.SUB_GRID_LB).on(Common.GetWheelEvent(), function (e) {
            var gridLB = $("#" + Torque.SUB_GRID_LB);
            gridLB.scrollTop(gridLB.scrollTop() - Common.GetWheelDelta(e));
        });
        $("#" + Torque.SUB_GRID_RB).on(Common.GetWheelEvent(), function (e) {
            var gridRB = $("#" + Torque.SUB_GRID_RB);
            gridRB.scrollTop(gridRB.scrollTop() - Common.GetWheelDelta(e));
        });
    }
