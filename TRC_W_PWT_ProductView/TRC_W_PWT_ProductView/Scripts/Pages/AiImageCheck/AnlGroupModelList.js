///////////////////////////////////////////////////////////////////////////////////////////////
// 型式紐づけ一覧画面(AnlGroupModelList)用制御関数
///////////////////////////////////////////////////////////////////////////////////////////////
// 型式紐づけ一覧画面派生呼び出し(PageLoad)
...
AnlGroupModelList = {
    ...
    ResizeGridArea: function () {
        ...
        //グリッド用DIVサイズ変更
        var gridArea = $("#" + AnlGroupModelList.GRID_MAIN_VIEW);
        ...
        if (0 < gridArea.length) {
            ...
            try {
                gridSize = containtsBottom - gridTop - AnlGroupModelList.INNER_DIV_H_MARGIN;
                if (gridSize < AnlGroupModelList.MIN_HEIGHT) {
                    //gridSize = AnlGroupModelList.MIN_HEIGHT;
                }
    ...
    ResizeGridArea2: function () {
        ...
        if (null != containtsArea.position()) {
            containtsBottom = containtsBottomArea.position().top - containtsArea.position().top + AnlGroupModelList.MIN_HEIGHT;
            if (null == containtsBottom) {
                containtsBottom = 0;
            }
        }
        ...
        if (0 < gridLT.length) {
            ...
            try {
                divMain_Height = containtsBottom - divMain_Top - AnlGroupModelList.INNER_DIV_H_MARGIN;
    ...
    ,
    Initialize: function () {
        $("#" + AnlGroupModelList.GRID_RB).scroll(function () {
            var gridRT = $("#" + AnlGroupModelList.GRID_RT);
            var gridLB = $("#" + AnlGroupModelList.GRID_LB);
            var gridRB = $("#" + AnlGroupModelList.GRID_RB);
        ...
        $("#" + AnlGroupModelList.GRID_LB).scroll(function () {
            var gridLB = $("#" + AnlGroupModelList.GRID_LB);
            var gridRB = $("#" + AnlGroupModelList.GRID_RB);
        ...
        $("#" + AnlGroupModelList.GRID_LB).on(Common.GetWheelEvent(), function (e) {
            var gridLB = $("#" + AnlGroupModelList.GRID_LB);
            gridLB.scrollTop(gridLB.scrollTop() - Common.GetWheelDelta(e));
        });
        $("#" + AnlGroupModelList.GRID_RB).on(Common.GetWheelEvent(), function (e) {
            var gridRB = $("#" + AnlGroupModelList.GRID_RB);
