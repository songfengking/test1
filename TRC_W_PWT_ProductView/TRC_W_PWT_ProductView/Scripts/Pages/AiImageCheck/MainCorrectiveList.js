///////////////////////////////////////////////////////////////////////////////////////////////
// 是正処置入力検査結果一覧画面(MainCorrectiveList)用制御関数
///////////////////////////////////////////////////////////////////////////////////////////////
/* 電子チェックシートイメージ画像用制御 */
...
AiImageDef = {
    ...
    ,
    CONST_BUTTON_VIEW_REFRESH: "MasterBody_btnViewRefresh"
    ,
    CONST_FRAME: "ifrmModal"
    ,
    //画面CLOSE
    DialogCloseModal: function () {
        parent.$("#" + this.CONST_PARENT_DISP).dialog('close');
        parent.$("#" + this.CONST_BUTTON_VIEW_REFRESH).trigger('click');
    ...
    InitializeTab: function () {
        $("#" + AiImageDef.GRID_MAIN_RB ).scroll(function () {
            var gridRTMain = $("#" + AiImageDef.GRID_MAIN_RT );
            var gridLBMain = $("#" + AiImageDef.GRID_MAIN_LB );
            var gridRBMain = $("#" + AiImageDef.GRID_MAIN_RB );
        ...
        $("#" + AiImageDef.GRID_MAIN_LB ).scroll(function () {
            var gridLBMain = $("#" + AiImageDef.GRID_MAIN_LB );
            var gridRBMain = $("#" + AiImageDef.GRID_MAIN_RB );
        ...
        $("#" + AiImageDef.GRID_MAIN_LB ).on(Common.GetWheelEvent(), function (e) {
            var gridLBMain = $("#" + AiImageDef.GRID_MAIN_LB );
            gridLBMain.scrollTop(gridLBMain.scrollTop() - Common.GetWheelDelta(e));
        });
        $("#" + AiImageDef.GRID_MAIN_RB ).on(Common.GetWheelEvent(), function (e) {
            var gridRBMain = $("#" + AiImageDef.GRID_MAIN_RB );
